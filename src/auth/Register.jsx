        ...
        >
          ...
          <div className="bg-ivory px-10 py-12 flex flex-col justify-center">
            ...
            <p className="text-ink/70 text-sm mb-6">
              Join Nilantra to explore handcrafted luxury.
            </p>
            ...
            <button
              className="
                bg-ink text-ivory py-2.5 rounded-full
            ...
            <p className="text-xs text-ink/60 mt-5">
              ...
              <Link to="/login" className="text-brand ml-1 hover:underline">
                Log In
              </Link>
            </p>
          </div>
