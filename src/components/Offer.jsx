        ...
        <div className="col-span-1 lg:col-span-5 flex flex-col gap-6 h-full">
          ...
          <div className="flex-1 relative group overflow-hidden rounded-[2rem] shadow-sm cursor-pointer min-h-[250px]">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-center items-start">
              <span className="text-white/80 uppercase tracking-widest text-xs font-bold mb-2">New Arrivals</span>
              <h3 className="text-3xl font-serif text-white mb-4">
                Modern <br/> <span className="italic text-[#d29a23]">Dining Chairs</span>
              </h3>
          ...
          <div className="flex-1 relative group overflow-hidden rounded-[2rem] bg-[#f5f3ef] cursor-pointer min-h-[250px] flex items-center">
            ...
            <div className="w-1/2 p-8 z-10">
              ...
              <h3 className="text-2xl font-serif text-[#03396C] mb-2 leading-tight">
                Buy 2 Get <br/> <span className="text-[#d29a23] font-bold">1 FREE</span>
              </h3>
              <p className="text-gray-500 text-sm mb-4">On all decor items</p>
              <button className="bg-[#03396C] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#d29a23] transition-colors">
                Grab Deal
              </button>
            </div>
